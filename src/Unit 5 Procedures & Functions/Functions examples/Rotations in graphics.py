...
def animateRotatingPolygon( initPolygon, rotationSpeed, velocity, numFrames ):
 ...
 #       centreDot = screen.create_oval( centre[0]-5,centre[1]-5,centre[0]+5,centre[1]+5,fill="red")
...
def animateAsteroidField( numAsteroids, vMax, omega, decayFactor, planetRadius, col ):
    ...
    for frame in range( 0, 300 ):
        ...
        for i in range(0, numAsteroids ):
            ...
            velocities[i][0] = decayFactor * velocities[i][0]
            velocities[i][1] = decayFactor * velocities[i][1]
...
animateAsteroidField( 200, 20, 20, 0.95, 100, "yellow" )       



poly = [[300,300],[400,300],[400,400], [400, 550]]
poly2 = [[100,100],[130,100],[120,120]]
omega = 20
v = [0,0]
#animateRotatingPolygon( poly2, omega, v, 200)
